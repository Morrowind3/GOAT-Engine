...
Object_SavesManager::Object_SavesManager(Scene& scene, bool active): GameObject(Transform{{0,0}}, active) {
    behaviors.insert(std::make_pair(Keys::_, std::make_shared<Behavior_SavesManager>(scene,true)));
    // Object_MainMenuBackground stuff
