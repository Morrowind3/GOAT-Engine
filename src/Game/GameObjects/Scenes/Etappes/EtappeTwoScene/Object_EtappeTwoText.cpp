#include "Object_EtappeTwoText.hpp"

Object_EtappeTwoText::Object_EtappeTwoText(Transform transform, bool active) : GameObject(transform, active) {
    ...
    text.insert(std::make_pair("timer_1", Text{
            ...
            20,
            {0,0,0,255},
            Transform{{800 + X, 500 + Y}, transform.layerGroup,1, 0, 1, 1},
            true}));
    text.insert(std::make_pair("timer_2", Text{
            ...
            20,
            {0,0,0,255},
            Transform{{1700 + X, 200+Y}, transform.layerGroup, 1,0, 1, 1},
            true}));
}
