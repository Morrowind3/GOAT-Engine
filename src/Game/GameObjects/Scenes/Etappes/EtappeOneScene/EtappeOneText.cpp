...
EtappeOneText::EtappeOneText(Transform transform, bool active) : GameObject(transform, active) {
    ...
    text.insert(std::make_pair("Welcome", Text{
            ...
            20,
            {0,0,0,255},
            Transform{{800 + X, 200 + Y}, transform.layerGroup, 0, 1, 1},
            true}));
    text.insert(std::make_pair("Tutorial_1", Text{
            ...
            16,
            {0,0,0,255},
            Transform{{800 + X, 600 + Y}, transform.layerGroup, 0, 1, 1},
            true}));
    text.insert(std::make_pair("Tutorial_2", Text{
            ...
            16,
            {0,0,0,255},
            Transform{{2200 + X, 400 + Y}, transform.layerGroup, 0, 1, 1},
            true}));
    text.insert(std::make_pair("Tutorial_3", Text{
            ...
            16,
            {0,0,0,255},
            Transform{{3800 + X, 0 + Y}, transform.layerGroup, 0, 1, 1},
            true}));
    text.insert(std::make_pair("Tutorial_4", Text{
            ...
            16,
            {0,0,0,255},
            Transform{{5200 + X, -200 + Y}, transform.layerGroup, 0, 1, 1},
            true}));
    text.insert(std::make_pair("Tutorial_5", Text{
            ...
            16,
            {0,0,0,255},
            Transform{{4400 + X, 150 + Y}, transform.layerGroup, 0, 1, 1},
            true}));
    text.insert(std::make_pair("Tutorial_6", Text{
            ...
            16,
            {0,0,0,255},
            Transform{{6700 + X, 0 + Y}, transform.layerGroup, 0, 1, 1},
            true}));
    text.insert(std::make_pair("Tutorial_7", Text{
            ...
            16,
            {0,0,0,255},
            Transform{{7700 + X, 0 + Y}, transform.layerGroup, 0, 1, 1},
            true}));
    text.insert(std::make_pair("Tutorial_8", Text{
            ...
            16,
            {0,0,0,255},
            Transform{{7600 + X, 40 + Y}, transform.layerGroup, 0, 1, 1},
            true}));
}