...
VictoryScreenManager::VictoryScreenManager(Transform transform, bool active) : GameObject(transform, active) {
    ...
    text.insert(std::make_pair("Title", Text{
            ...
            60,
            {255,255,255,255},
            Transform{{530,40},transform.layerGroup,0,1,1},
            true}));
    text.insert(std::make_pair("Garbage", Text{
            ...
            40,
            {255,255,255,255},
            Transform{{210,580},transform.layerGroup,0,1,1},
            true}));
    text.insert(std::make_pair("Timelabel", Text{
            ...
            40,
            {255,255,255,255},
            Transform{{705,660},transform.layerGroup,0,1,1},
            true}));
    text.insert(std::make_pair("Timestamp", Text{
            ...
            40,
            {255,255,255,255},
            Transform{{920,620},transform.layerGroup,0,1,1},
            true}));
    text.insert(std::make_pair("Score", Text{
            ...
            40,
            {255,255,255,255},
            Transform{{670,740},transform.layerGroup,0,1,1},
            true}));
