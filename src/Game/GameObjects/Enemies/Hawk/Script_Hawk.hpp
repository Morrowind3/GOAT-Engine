#ifndef GOAT_ENGINE_SCRIPT_HAWK_HPP
#define GOAT_ENGINE_SCRIPT_HAWK_HPP
...
class Script_Hawk : public Script {
public:
    Script_Hawk(Object_Hawk& self, bool active) : Script(active), _self(self), _startingPos(self.transform.position) {};
...
#endif //GOAT_ENGINE_SCRIPT_HAWK_HPP
