...
CheatsBehavior::CheatsBehavior(Scene& scene, Object_Player& player, std::map<std::string,Text>& textObjects,
    ...
    scripts.insert(std::make_pair(Keys::ETAPPE_SELECT, std::make_shared<BeatLevelScript>( beatGameSound, true)));
}
