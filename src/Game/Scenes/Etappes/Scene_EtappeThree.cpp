...
Scene_EtappeThree::Scene_EtappeThree() : SceneTemplate_Etappe(Keys::ETAPPE_THREE,
    ...
    gameObjects.emplace_back(std::make_shared<Object_TimerLine>(4,Transform{{0,-3500},LAYER::TIMER_LINE,1, 0, 3, 80}, true ));
}
