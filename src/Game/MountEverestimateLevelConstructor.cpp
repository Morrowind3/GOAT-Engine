...
MountEverestimateLevelConstructor::MountEverestimateLevelConstructor(SceneTemplate_Etappe& etappe, const std::string& fileLocation,
...
void MountEverestimateLevelConstructor::placeTile(int index, Transform transform) {
    ...
    switch (index) {
        ...
        case 36:
            ...
            break;
        case 37:
            _etappe.gameObjects.emplace_back(std::make_shared<Object_Hawk>(transform, true));
            break;
        case 45:
        ...
        case 74:
            ...
            transform.layerGroup = LAYER::TILES_BACK;
            _etappe.gameObjects.emplace_back(std::make_shared<Object_Cloud>(Object_Cloud::CloudShape::BIG, transform, true));
            break;
        case 75:
            transform.layerGroup = LAYER::TILES_BACK;
            _etappe.gameObjects.emplace_back(std::make_shared<Object_Cloud>(Object_Cloud::CloudShape::SMALL, transform, true));
            break;
        case 76:
            transform.layerGroup = LAYER::TILES_BACK;
            _etappe.gameObjects.emplace_back(std::make_shared<Object_Cloud>(Object_Cloud::CloudShape::WIDE, transform, true));
            break;
        case 77:
